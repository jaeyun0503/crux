...
/**
 * A function, which is the lowered version of a {@link FunctionDef}. The difference to the AST
 * version is, that the body of the function does not consist of a list of statements, but instead
