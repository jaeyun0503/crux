...
public final class ASTPrinter {
  ...
  private final class PrinterVisitor extends DefaultNodeVisitor<String> {
    ...
    public String visit(FunctionCall functionCall) {
      String str = functionCall.getCallee().getName() + "(";
    ...
    public String visit(FunctionDef functionDef) {
      String str = functionDef.getSymbol().getName() + "(";
      boolean isFirst = true;
      for (Symbol p : functionDef.getParameters()) {
        if (isFirst)
          isFirst = false;
        else
          str += ", ";
      ...
      str += ") ";
      str += functionDef.getStatements().accept(this);
      return str;
    }
    ...
    @Override
    public String visit(WhileLoop loop) {
      String str = "while (" + loop.getCondition().accept(this) + ")";
      String body = loop.getBody().accept(this);
      str += " " + body;
      return str;
    }
